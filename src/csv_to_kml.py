...
if __name__ == "__main__":
    ...
    # processing options
    parser.add_argument('-sp','--show_point',type=bool,help="Show points",default=True)
    parser.add_argument('-sl','--show_line',type=bool,help="Show the lines between points",default=True)
    #parser.add_argument('-','--',type=,help="",default="",choices=[""])
    #parser.add_argument('-','--',type=,help="",default="",choices=[""])
